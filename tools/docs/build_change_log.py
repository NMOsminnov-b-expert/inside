...
Листы:
  ...
  «Только в гражданском» — содержательные правки гражданского, ещё не
...
def build():
    ...
    for _, _, r, c in rows:
        civil_only = r['scope'] in ('civil', 'civil_vehicle') and not D.spread_of(r)
        if civil_only and r['kind'] in D.CONTENT_KINDS:
