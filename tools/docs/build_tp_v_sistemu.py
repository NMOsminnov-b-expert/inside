...
LAND_MAIN_ADDR = LAND_MAIN + ((0, 0, 987, 296),)
...
OC_PLACE_TOP = ('Screenshot 2026-09-24 144339.png', 'Объект оценки · 02 Местоположение', (0, 0, 952, 246))
...
GA_FIGURES = [
    ...
    ('Идентификационный номер и место расположения', 3, (40, 60, 890, 260), [
        ((400, 176, 586, 207), LAND_MAIN_ADDR, (14, 84, 248, 115), 'Идентификационный номер',
         'Земельный участок · Основные параметры · ЕНИ'),
        ((665, 181, 777, 210), OC_PLACE_TOP, (325, 196, 622, 238), 'Населённый пункт',
         'Объект оценки · Местоположение · Город или село'),
        ((670, 208, 857, 237), LAND_MAIN_ADDR, (14, 254, 972, 286), 'Улица, дом',
