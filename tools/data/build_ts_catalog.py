...
KEYS = {
    ...
    'Регистрационный номер': 'plate', 'Уникальный идентификатор (VID)': 'vid', 'Собственник': 'owner',
    'ИНН (ПИН) собственника': 'ownerInn', 'Адрес собственника': 'ownerAddr', 'Дата регистрации': 'regDate',
...
BLOCK = {
    'plate': 'reg', 'vid': 'reg', 'owner': 'reg', 'ownerInn': 'reg', 'ownerAddr': 'reg', 'regDate': 'reg',
