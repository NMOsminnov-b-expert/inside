...
# Классы таблицы, которые в классификатор механизмов не идут.
# «Спецтехника» — это транспортные средства (решение пользователя 22.09.2026:
# «спецтехника относится к ТС, всё, что на колёсах, — ТС»): её подгруппы
# заведены типами ТС в app/modules/vehicle/data/vehicleFields.js.
SKIP_CLASSES = {'Спецтехника'}
