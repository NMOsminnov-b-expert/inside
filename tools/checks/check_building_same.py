...
MUST = [
    ...
    # Ищем сам блок пристроек, а не класс «.al»: тот был общим для списков
    # площадей и поэтажной развёртки, и проверка проходила за счёт развёртки —
    # даже если бы пристройки из карточки пропали. Развёртка с 14.09.2026 стала
    # обычной таблицей, и подмена вскрылась.
    ('[data-ax-add]', 'пристрои, балконы и лоджии'),
