...
TOUCHES = (
    'app/pages/dicts/*', 'app/kernel/dicts.js', 'app/modules/*/data/*',
)
...
def run(t):
    ...
    # Одиннадцать: девять конструктивных элементов плюс отделка и утепление —
    # у них с 11.09.2026 тоже есть свои материалы (решение пользователя). До
    # этого на их месте в таблице стоял прочерк.
    t.ck(len(parts) == 11,
         'в папке состава %d справочников вместо одиннадцати' % len(parts))
