...
def run(t):
    ...
    #
    # Берём жилой дом: у литеры ГРАЖДАНСКОГО здания своих координат больше нет —
    # местоположение целиком у объекта оценки, блок «Местоположение» (решение
    # пользователя 09.09.2026). Остальные типы ОЦ правка не касалась.
    if _open_oi(t, '#/oc/residential-house/oc-rh-1/oi/oi-a', '[data-oi-gps]'):
