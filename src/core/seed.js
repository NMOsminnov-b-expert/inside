...
export function createOC() {
  return {
    ...
    // По умолчанию ОЦ не является имущественным комплексом.
    complex: false,
...
export function createOI() {
  return [
...

    {
      ...
      areas: { tp: '18.20', pud: '', fact: '18.20', build: '18.60' },
      floors: 1,
      floorList: [],
      heights: { ext: '', int: '' },
      buildType: 'Отдельностоящее',
      ...
      notes: [
        mkNote('Фото внутри помещений отсутствуют', false),
      ],
    },
