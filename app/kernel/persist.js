...
// грохни»: заведённое в браузере до этого дня (в том числе литеры и ТС
// прежнего образца) отбрасывается, остаются засеянные записи. Снимок другой
// версии не читается и удаляется при первом открытии.
const VERSION = 2;
