...
//
// ДЛЯ СЕРВЕРНОЙ ВЕРСИИ: состав, порядок и ширина столбцов — личная настройка
// пользователя, и её ждут сохранённой между сеансами. В макете она живёт в
// памяти сессии. На сервере это профиль пользователя либо localStorage; выбор
// за разработчиками (профиль переезжает между машинами, localStorage дешевле).
//
