...
export const COLUMNS = [
  // Столбец показывает коды всей записи одной строкой: свой код и коды объектов
  ...
  { key: 'eni', label: 'Код ЕНИ', width: 210, minWidth: 134, mono: true, sort: 'eni' },
  ...
  // Тип земель и коды ЕНИ объектов имущества — по заметкам команды 05.09.2026.
  // Тип считается по участкам записи, коды сворачиваются: общее начало один раз,
  // различающиеся хвосты через запятую (kernel/eniFold.js).
  { key: 'landKind', label: 'Тип земель', width: 116 },
