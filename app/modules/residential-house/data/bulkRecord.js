...
function landOi(id, i, p, suffix, opts = {}) {
  ...
  return {
    ...
    location: i % 2 ? 'На окраине населенного пункта' : 'В центре населенного пункта',
    locationFeatures: '',
    roadLocation: 'Внутри района',
    corner: i % 2 ? 'Угловой' : 'Неугловой',
    encumbrance: i % 5 === 0 ? 'Есть' : 'Нет',
    encumbranceArea: i % 5 === 0 ? fmt(Math.max(4, rawArea * 0.1)) : '',
    buildings: 'Есть',
    buildingType: 'Жилой дом',
    buildingArea: fmt(Math.max(8, rawArea * 0.3)),
