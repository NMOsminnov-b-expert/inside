...
// Выпадающий список части адреса со значением, которого в справочнике может и
// не быть: адрес приходит из Кадастра и из вставленной строки, там пишут как
// придётся («обл. Чуй» против «Чуйская область»), а терять введённое из-за
// несовпадения со справочником нельзя. Такое значение помечено — видно, что
// справочник его не знает.
