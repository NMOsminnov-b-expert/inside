...
// Названия колонок 10.09.2026 приведены к тому, как площади называют в
// техпаспорте, — вслед за блоком «Площади и этажность» и карточкой гражданского
// здания: «по ТП» стала «по внешним замерам», «площадь застройки» — «по
// внутреннему обмеру». Прежняя оговорка «застройка — она же по наружным
// замерам» (28.08.2026) с этим расходилась и снята. Ключи данных (area,
// areaBuild, areas.tp, areas.build) не менялись — переименование подписи не
// должно ломать уже введённое.
export const AREA_FIELDS = [
  { key: 'area', total: 'tp', label: 'По внешним замерам, м²', title: 'площадь по внешним замерам' },
  { key: 'areaBuild', total: 'build', label: 'По внутреннему обмеру, м²', title: 'площадь по внутреннему обмеру' },
];
