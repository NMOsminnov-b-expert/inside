...
// У этого модуля нет ни одного вида ОИ (rec.oi всегда пуст/отсутствует —
// см. app/modules/mechanisms/records.js), поэтому в отличие от production
// сумма считается защищённо: без guard'а `rec.oi.reduce(...)` бросал бы
// исключение на каждой записи.
