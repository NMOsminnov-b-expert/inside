...
// у них поле. Распределяется только общая площадь по техпаспорту: она и есть
// сумма этажей. Площадь застройки — площадь среза сверху, этажи на неё чаще
// всего не влияют, поэтому её вводят руками и по строкам не делят (решение
// пользователя 09.09.2026).
export const AREA_FIELDS = [
  {
    key: 'area', total: 'tp', label: 'Площадь по ТП, м²',
    title: 'общая по техпаспорту', auto: true,
  },
  ...
  // наружные замеры остаётся: под этим названием её знают на местах.
  {
    ...
    title: 'площадь застройки — она же по наружным замерам', auto: false,
  },
];
