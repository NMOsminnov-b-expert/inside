...
//
// Своё название группы (oi.groupName) бывает только у бывшего комплекса
// («Комплекс техники (серверная)») — оно описывает группу целиком и важнее
// названия первой единицы.
