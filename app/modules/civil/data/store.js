...
const UI_KEEP = [
  ...
  'floorCols',
  'railCollapsed',
  // Свёрнута ли шкала статусов в шапке ОЦ — выбор человека, как и раскрытые
  // блоки.
  'statusCollapsed',
  // Режим раскрытия просмотрщика (документ слева во всю высоту) — рабочий
  // выбор человека, а не состояние одного экрана.
  'viewerDock',
];
