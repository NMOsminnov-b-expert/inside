...
// residential помечает жилое строение, litKind — вид литеры по умолчанию.
//
// Здание одно: гражданское оно или производственно-складское, указывают уже
// внутри карточки по фото (решение пользователя 23.09.2026: «при создании
// здания мы создаём здание, после внутри указываем тип ОИ»).
export const REALTY_OI_TYPES = [
  { label: 'Земельный участок', card: 'land' },
  { label: 'Квартира', card: 'apartment' },
  { label: 'Здание', card: 'building' },
  { label: 'Жилой дом', card: 'building', residential: true },
  { label: 'Прочее строение', card: 'building', litKind: 'other' },
