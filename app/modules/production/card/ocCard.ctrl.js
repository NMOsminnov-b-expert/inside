...
function createOi(ctx, type) {
  ...
  const oi = {
    ...
    comment: '',
    // Назначение по умолчанию — от ВИДА ОИ, а не от типа ОЦ: «Производственное
    // строение» приносит своё назначение само (type.catClass), а жилой дом и
    // гражданское здание получали производственно-складское только потому, что
    // заведены в производственном объекте оценки — вместе с блоком доп.
    // параметров и обязательными высотой и стенами (правка 04.09.2026).
