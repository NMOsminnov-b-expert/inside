...
const COMMON = {
  ...
  // Квартира (oi.apartment.*). Карточка квартиры импортируется из модуля
  // «жилое здание (квартира)» во все типы ОЦ, поэтому подписи её полей нужны
  // здесь тоже: без них лог правок показывает ключи данных.
  ...
  // Планировки квартиры и тип строения: ключи приходят без приставки карточки.
  // Планировки правятся в карточке квартиры, которая импортируется во все типы
  // ОЦ, поэтому подпись нужна здесь тоже — иначе лог показывает «plans».
  plans: 'Планировки',
