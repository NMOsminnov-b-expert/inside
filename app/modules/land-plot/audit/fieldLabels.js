...
// ОЦ разный (основное здесь — сам участок, у производственного строения набор другой), а ядро не знает ни одного типа ОЦ.
...
const COMMON = {
  ...
  status: 'Статус',
  // У земли техпаспорта нет — есть целевое назначение (решение пользователя
  // 10.09.2026). Подпись «по ТП» досталась от карточек строений.
  purposeTP: 'Целевое назначение',
  ...
  // Класс объекта имущества (поле «Класс ОИ» карточки строения): без подписи
  // лог показывал сырой ключ oiCategory.
  oiCategory: 'Класс ОИ',
  ...
  // Фундамент, наружные и внутренние стены: строки в таблице износа есть, а
  // подписей не было — лог правок показывал сырой ключ wear.foundation.
  'wear.foundation': 'Износ · фундамент',
  'wear.wallsExt': 'Износ · наружные стены',
  'wear.wallsInt': 'Износ · внутренние стены',
  ...
  // Доп. параметры производственного строения: блок распространён на все
  // типы ОЦ 05.09.2026 — подписи нужны и здесь.
  prodFrame: 'Каркас',
...
const BY_CARD = {
  ...
  land: {
    ...
    leased: 'Участок в аренде',
    leasePrice: 'Стоимость аренды',
    leaseUnit: 'Единица измерения аренды',
    leaseTerm: 'Срок аренды',
    leaseNote: 'Комментарий к аренде',
    gps: 'Координаты участка',
    zone: 'Крупная зона',
    microdistrict: 'Микрорайон',
    distanceToCenter: 'Удалённость от райцентра',
    improvementRank: 'Наличие благоустройства',
