...
<select class="select" data-land-form style="flex:1 1 200px">${options(LAND_FORM, oi.form)}</select>
...
${selectField('Категория и разрешенное использование', 'data-land-use', LAND_USE_CATEGORIES, oi.useCategory)}${selectField('Доступность полива', 'data-land-irrigation', IRRIGATION_ACCESS, oi.irrigation)}${selectField('Тип полива', 'data-land-irrigation-type', IRRIGATION_TYPE, oi.irrigationType)}<div class="field"><label>Тип почвы</label><input class="input" data-land-soil value="${esc(oi.soil || '')}"></div>
