...
<div class="field"><label>Наименование</label><input class="input" data-oi-name value="${esc(oi.name)}"></div>
...
<button class="btn btn-danger" data-del-oi="${oi.id}">Удалить участок</button>
