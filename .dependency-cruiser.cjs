  ...
  forbidden: [
    {
      ...
      comment:
        ...
        + 'карточка квартиры (apartment/oi/apartment) и карточка ТС '
        + '(vehicle/card.js): они одни на весь проект и переиспользуются '
        + 'остальными модулями осознанно.',
      severity: 'error',
      ...
      to: {
        ...
        pathNot: [
          ...
          // Карточка ТС внутри гражданского здания — через одну дверь
          // (решение пользователя 23.09.2026).
          '^app/modules/vehicle/card\.js$',
